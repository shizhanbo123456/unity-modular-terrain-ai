...
namespace UnityPythonBridge.Commands
{
    ...
    public static class MeshBoundsCommand
    {
        ...
        public static object Bounds(BridgeContext ctx, Newtonsoft.Json.Linq.JObject args)
        {
        ...
        private static object BuildResult(string inputPath, string resolvedPath, string type, Bounds b)
        {
            ...
            return new Newtonsoft.Json.Linq.JObject
            {
                ...
                ["type"] = type,
                ["min"] = new Newtonsoft.Json.Linq.JObject { ["x"] = min.x, ["y"] = min.y, ["z"] = min.z },
                ["max"] = new Newtonsoft.Json.Linq.JObject { ["x"] = max.x, ["y"] = max.y, ["z"] = max.z },
                ["center"] = new Newtonsoft.Json.Linq.JObject { ["x"] = center.x, ["y"] = center.y, ["z"] = center.z },
                ["size"] = new Newtonsoft.Json.Linq.JObject { ["x"] = size.x, ["y"] = size.y, ["z"] = size.z },
